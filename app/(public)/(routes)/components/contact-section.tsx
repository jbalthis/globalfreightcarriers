...
const ContactSection = () => {
  return (
    <section className="mb-32">
      <h1 className="text-center text-3xl font-bold mb-16">Still have questions? Reach out</h1>
    <div
      ...
      <div
        ...
        <div className="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="mx-auto mb-12 text-center lg:mb-0">
            ...
            <h6 className="font-medium">Westlake, OH 44145</h6>
          </div>
          <div className="mx-auto mb-6 text-center md:mb-0">
            ...
            <h6 className="font-medium">(440)877-SHIP</h6>
          </div>
          <div className="mx-auto text-center">
            ...
            <h6 className="font-medium">MC: 1503358</h6>
          </div>
        </div>
