...
const ResourcesJumbotron = () => {
  return (
    <section className="bg-center bg-no-repeat bg-[url('/images/solar.jpg')] bg-gray-700 bg-blend-multiply mb-12">
...
export default ResourcesJumbotron;
